...
namespace TableStorage.Abstractions.POCO
{
	public interface IPocoTableStore<T, TPartitionKey, TRowKey>
	{
		...
		/// data across many partitions, prefer to use <see cref="PocoTableStore{T,TPartitionKey,TRowKey}.GetByPartitionKey(string)"/>
		/// </summary>
		/// <param name="rowKey">The row key.</param>
		/// <returns>IEnumerable&lt;T&gt;.</returns>
		...
		/// <summary>
		/// Gets records by row key. This method may be slow if there is a high volume of 
		/// data across many partitions, prefer to use <see cref="PocoTableStore{T,TPartitionKey,TRowKey}.GetByRowKeyPaged(string,int,string)"/>
		/// </summary>
		/// <param name="rowKey">The row key.</param>
		/// <param name="pageSize">Size of the page.</param>
		/// <param name="continuationTokenJson">The continuation token json.</param>
		...
		/// <summary>
		/// Gets all records.  This method may be slow if there is a high volume of 
		/// data across many partitions, prefer to use <see cref="PocoTableStore{T,TPartitionKey,TRowKey}.GetByPartitionKeyPaged(string,int,string)"/>
		/// </summary>
		/// <param name="pageSize">Size of the page.</param>
		...
		/// <summary>
		/// Gets the records by filter.  Note that the filter is applied after the table storage query, so prefer to use Gets the records by filter.  Note that the filter is applied after the table storage query, so prefer to use <see cref="PocoTableStore{T,TPartitionKey,TRowKey}.GetByPartitionKey(string,System.Func{T,bool})"/>
		/// </summary>
		...
		/// data across many partitions, prefer to use <see cref="PocoTableStore{T,TPartitionKey,TRowKey}.GetByPartitionKeyAsync(string)"/>
		/// </summary>
		/// <param name="rowKey">The row key.</param>
		/// <returns>Task&lt;IEnumerable&lt;T&gt;&gt;.</returns>
		...
		/// <summary>
		/// Gets the records by filter.  Note that the filter is applied after the table storage query, so prefer to use Gets the records by filter.  Note that the filter is applied after the table storage query, so prefer to use <see cref="PocoTableStore{T,TPartitionKey,TRowKey}.GetByPartitionKeyAsync(string,System.Func{T,bool})"/>
		/// </summary>
		/// <param name="filter">The filter.</param>
		/// <param name="start">The start.</param>
		/// <param name="pageSize">Size of the page.</param>
